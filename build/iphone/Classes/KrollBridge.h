...
@interface k1508_AboutMe_Cole_DeonslowObject : KrollCoverageObject {
#else
@interface k1508_AboutMe_Cole_DeonslowObject : KrollObject {
#endif
@private
...
extern NSString * k1508_AboutMe_Cole_Deonslow$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k1508_AboutMe_Cole_DeonslowObject *_k1508_aboutme_cole_deonslow;
    KrollObject* console;
	BOOL shutdown;
