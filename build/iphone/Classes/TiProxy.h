...
//Rare exceptions to indicate a bug in the _k1508_aboutme_cole_deonslow code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k1508_AboutMe_Cole_Deonslow proxies.
 */
